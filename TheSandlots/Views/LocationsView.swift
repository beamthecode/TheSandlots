...
struct LocationsView: View {
    ...
    @State private var mapRegion: MKCoordinateRegion = MKCoordinateRegion(center: CLLocationCoordinate2D(latitude: 38.9515, longitude: -92.3286), span: MKCoordinateSpan(latitudeDelta: 0.1, longitudeDelta: 0.1))
